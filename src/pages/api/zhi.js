...
const { JSDOM } = jsdom
const dom = new JSDOM(
  `<!DOCTYPE html><html lang="cn"><head></head><body></body></html>`,
...
var __g = {
  x: function (e, t) {
    for (var n = [], r = e.length, i = 0; 0 < r; r -= 16) {
      for (
        var o = e.slice(16 * i, 16 * (i + 1)), a = new Array(16), c = 0;
        c < 16;
        c++
      )
        a[c] = o[c] ^ t[c]
...
// const cookie = "d_c0=\"AFBXUNNEkxGPToBPu1tCz58X1x6ETvP_kvY=|1594720821\";"
// const url =
//   '/api/v4/answers/2966507634/voters'
// const body = "{\"type\":\"up\"}"
// const zse93 = '101_3_3.0'
// const x81 = '3_2.0aR_sn77yn6O92wOB8hPZnQr0EMYxc4f18wNBUgpTQ6nxERFZmXY0-4Lm-h3_tufIwJS8gcxTgJS_AuPZNcXCTwxI78YxEM20s4PGDwN8gGcYAupMWufIoLVqr4gxrRPOI0cY7HL8qun9g93mFukyigcmebS_FwOYPRP0E4rZUrN9DDom3hnynAUMnAVPF_PhaueTFRwGcqtLx9OOucHYk4wy99O9-gCGmCSMfhHLNbOVU9LqxqNLfgU8TwCprgoTVHLGeTX92qFBoicBnvxC-CNfp9gKsbxCfBL1fDgLIgtsNhLY80F0yDcfFBt12JS_2hF16L3qhgLGAhLyK8L9bRN__Do_2AL82GgB2HuBiqgOrJN_4CL0Cg_zwcnpJDoMBHeVQhXY-DO9_Bc9dugK2630rHxKrBCqfigB6GS0khYBQGLYMMe8WgN8b9cXjBtqFcfqPGRqICcXzUpL_UNKS7LCVBVxkTX16uVmQ7SLQX2s'
// console.log(getZse96(cookie, url, body, zse93, x81))

// console.log(D("7523a72e8000c8efd42a926522968341"))
